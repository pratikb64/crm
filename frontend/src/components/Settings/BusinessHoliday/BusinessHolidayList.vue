  ...
  >
    ...
    <template #content>
      ...
      <div v-else class="h-full">
        <div
          v-if="
            !holidayListResource.list.loading &&
            !holidayListResource.list.data?.length
          "
          ...
          >
            ...
            >
              ...
              >
                ...
                <Badge v-if="holidayList.default" color="gray" size="sm"
                  >Default</Badge
                >
              </div>
              <div class="col-span-1 text-ink-gray-8 text-sm">
                {{ holidayList.apply_on == 'CRM Lead' ? 'Lead' : 'Deal' }}
              </div>
              <div class="flex justify-between items-center w-full pr-2">
                <div>
                  <Switch
                    size="sm"
                    :modelValue="holidayList.enabled"
                    @update:modelValue="onToggle(holidayList)"
                  />
                </div>
                <div>
                  <Dropdown
