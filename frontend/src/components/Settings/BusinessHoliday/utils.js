...
export const businessHolidayDataErrors = ref({
  holiday_list_name: '',
  from_date: '',
  to_date: '',
})

export const businessHolidayData = ref({
  holiday_list_name: '',
  description: '',
...
export const validateBusinessHolidayData = () => {
  const errors = validateHoliday()
}

export const resetBusinessHolidayDataErrors = () => {
  businessHolidayDataErrors.value = {
    holiday_list_name: '',
    from_date: '',
    to_date: '',
  }
...
export const validateHoliday = (key) => {
  ...
  if (key) {
    ...
    Object.keys(holidayDataErrors.value).forEach(validateField)
  }
